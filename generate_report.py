...
def create_report():
    output_pdf = "g:\\RNG Extractors\\Report\\RNG_Extractors_Comprehensive_Report.pdf"
    ...
    def add_image(filepath, width_ratio=1.0):
        if os.path.exists(filepath):
            img = Image(filepath)
            aspect = img.drawHeight / float(img.drawWidth)
            
            max_width = 500 * width_ratio
            ...
            img.drawHeight = calc_height
            
            Story.append(img)
            Story.append(Spacer(1, 0.2 * inch))
        else:
            add_paragraph(f"<i>[Image not found: {filepath}]</i>")

    # Title
    add_heading("RNG Extractors - Web Application Comprehensive Report", title_style)

    # 1. Introduction & Workflow
    add_heading("1. User Workflow and Extracted Output", heading2_style)
    ...
    add_heading("2. Overview Page", heading2_style)
    ...
    add_image(r"g:\RNG Extractors\Report\Overview.png", 0.7)

    # 3. Documentation Page
    Story.append(PageBreak())
    add_heading("3. Documentation Page", heading2_style)
    ...
    add_image(r"g:\RNG Extractors\Report\Doumentation.png", 0.9)

    # 4. Analyze Page Workflow
    Story.append(PageBreak())
    add_heading("4. Analyze Page and Interaction Flow", heading2_style)
    ...
    add_heading("Step 4.1: Data Input and Configuration", heading3_style)
    ...
    add_image(r"g:\RNG Extractors\Report\Analyze 1.png", 0.8)
    add_image(r"g:\RNG Extractors\Report\Analyze 2.png", 0.8)

    Story.append(PageBreak())
    add_heading("Step 4.2: Execution and Logging", heading3_style)
    ...
    add_image(r"g:\RNG Extractors\Report\Analyze 3.png", 0.8)
    add_image(r"g:\RNG Extractors\Report\Analyze 4.png", 0.8)

    Story.append(PageBreak())
    add_heading("Step 4.3: Analysis Complete & Main Dashboard", heading3_style)
    ...
    add_image(r"g:\RNG Extractors\Report\Analyze 5.png", 0.8)

    Story.append(PageBreak())
    add_heading("Step 4.4: Interactive Chart Exploration", heading3_style)
    ...
    add_image(r"g:\RNG Extractors\Report\Analyze 6.png", 0.8)
    add_image(r"g:\RNG Extractors\Report\Analyze 9.png", 0.8)
    ...
    add_image(r"g:\RNG Extractors\Report\Analyze 10.png", 0.8)
    add_image(r"g:\RNG Extractors\Report\Analyze 7.png", 0.8)
    add_image(r"g:\RNG Extractors\Report\Analyze 8.png", 0.8)

    Story.append(PageBreak())
    add_heading("Step 4.5: Data Export and Archiving", heading3_style)
    ...
    add_image(r"g:\RNG Extractors\Report\Analyze 11.png", 0.8)
    add_image(r"g:\RNG Extractors\Report\Analyze 13.png", 0.8)
    add_image(r"g:\RNG Extractors\Report\Analyze 14.png", 0.8)
    add_image(r"g:\RNG Extractors\Report\Analyze 15.png", 0.8)

    Story.append(PageBreak())
    add_heading("Step 4.6: PDF Report Generation", heading3_style)
    ...
    add_image(r"g:\RNG Extractors\Report\Analyze 12.png", 0.8)
    add_image(r"g:\RNG Extractors\Report\Analyze 16.png", 0.8)
    add_image(r"g:\RNG Extractors\Report\Analyze 17.png", 0.8)
